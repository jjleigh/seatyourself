...
Category.create!(
	...
	Category.create!(
		...
		:summary => "Find awesome Carribbean cuisine restuarants in your area, We have many to choose from. Come taste the flavours of the islands and try Jamaican, Trinidadian, Cuban"
		)
	Category.create!(
		:cuisine => "European",
